...
if __name__ == "__main__":
    ...
    for i in range(int(num)):
        ...
        MDGPR = [f'target=`sed -n $((3*PBS_ARRAY_INDEX-2))"P" md_targets_{i}.txt`', f'engine=`sed -n $((3*PBS_ARRAY_INDEX-1))"P" md_targets_{i}.txt`', f'md=`sed -n $((3*PBS_ARRAY_INDEX))"P" md_targets_{i}.txt`',
